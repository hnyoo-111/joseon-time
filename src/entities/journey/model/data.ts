...
export const JOURNEYS: Journey[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'd6', phase: '오늘날', title: '오늘날의 이야기', year: '2026 · 1457', lon: 128.4693, lat: 37.1863, height: 10, relatedWorks: ['wanggwa-saneun-namja'],
        desc: '단종의 유배와 그를 숨어서 돌본 영월 촌로 엄흥도의 이야기는 오늘날 영화 「왕과 사는 남자」(2026) 등으로 재해석되고 있습니다.' },
    ],
  },
];
