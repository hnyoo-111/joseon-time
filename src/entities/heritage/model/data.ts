...
/**
 * imageUrl(public/heritage-photos/*.jpg)은 전부 Wikimedia Commons의 CC BY / CC BY-SA 라이선스
 * 사진을 800px로 리사이즈해 받아온 것입니다 — 저작권 확인 안 된 이미지는 넣지 않았습니다
 * (관풍헌·울돌목은 믿을 만한 자유 라이선스 사진을 못 찾아 비워뒀습니다, 아이콘으로 대체 표시).
 * 원본·라이선스·저작자 출처:
 *  - gyeongbok:      commons.wikimedia.org/wiki/File:Front_view_of_the_Imperial_Throne_Hall_Geunjeongjeon_at_Gyeongbokgung_Palace_with_blue_sky_in_Seoul.jpg (CC BY-SA 4.0)
 *  - changdeok:      commons.wikimedia.org/wiki/File:Changdeokgung_Palace.jpg (CC BY-SA 4.0)
 *  - changgyeong:    commons.wikimedia.org/wiki/File:Korea-Seoul-Changgyeonggung-Myeongjeongjeon-01.jpg (CC BY-SA 2.0)
 *  - hwaseong:       commons.wikimedia.org/wiki/File:Hwaseong_Fortress-002.jpg (CC BY 2.0)
 *  - namhan:         commons.wikimedia.org/wiki/File:Namhanssanseong.JPG (CC BY-SA 3.0 / GFDL)
 *  - jongmyo:        commons.wikimedia.org/wiki/File:Jongmyo_Royal_Shrine_(종묘)_Day_of_Rites_and_ceremonies.jpg (CC BY-SA 4.0)
 *  - cheongnyeongpo: commons.wikimedia.org/wiki/File:CheongRyeongpo_Eoso.JPG (CC BY-SA 3.0)
 *  - jangneung:      commons.wikimedia.org/wiki/File:Danjong_jangreung.jpg (CC BY 3.0)
 * CC BY(-SA) 라이선스는 공개 배포 시 저작자 표시 의무가 있습니다 — 화면에 출처 크레딧을
 * 노출할지는 별도로 정해야 합니다(유물 아카이브 페이지의 공공누리 고지처럼).
 */
export const HERITAGES: Heritage[] = [
  {
    ...
    imageUrl: '/heritage-photos/gyeongbok.jpg',
  },
  {
    ...
    imageUrl: '/heritage-photos/changdeok.jpg',
  },
  {
    ...
    imageUrl: '/heritage-photos/changgyeong.jpg',
  },
  {
    ...
    imageUrl: '/heritage-photos/hwaseong.jpg',
  },
  {
    ...
    imageUrl: '/heritage-photos/namhan.jpg',
  },
  {
    ...
    imageUrl: '/heritage-photos/jongmyo.jpg',
  },
  {
  ...
  },
  {
    ...
    imageUrl: '/heritage-photos/cheongnyeongpo.jpg',
  },
  {
  ...
  },
  {
    ...
    imageUrl: '/heritage-photos/jangneung.jpg',
  },
];
