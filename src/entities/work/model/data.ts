...
export const WORKS: Work[] = [
  ...
  { id: 'gongjuui-namja', title: '공주의 남자', cat: 'drama', year: '2011', kings: ['danjong'], heritages: ['cheongnyeongpo'], figures: ['수양대군', '김승유', '이세령'], tagline: '계유정난의 소용돌이 속, 원수 집안 두 남녀의 비극적 사랑' },
